...
import erogenousbeef.bigreactors.net.message.ReactorChangeRedstoneMessage;
...
public class GuiReactorRedstonePort extends BeefGuiBase {
	...
	protected void actionPerformed(GuiButton clickedButton) {
		if(clickedButton.id == 0) {
            ...
            CommonPacketHandler.INSTANCE.sendToServer(new ReactorChangeRedstoneMessage(port.xCoord, port.yCoord, port.zCoord, newCircuitType.ordinal(), actualOutputLevel, this.greaterThan, this.activeOnPulse));
        }
