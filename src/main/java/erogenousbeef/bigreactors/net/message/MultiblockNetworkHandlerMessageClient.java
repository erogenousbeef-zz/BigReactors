...
public class MultiblockNetworkHandlerMessageClient implements IMessage, IMessageHandler<MultiblockNetworkHandlerMessageClient, IMessage> {
    private int id, x, y, z;
    private Object[] data;
    private DataInputStream dis;

    public MultiblockNetworkHandlerMessageClient(int id, int x, int y, int z, Object... data) {
        this.id = id;
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    @Override
    public IMessage onMessage(MultiblockNetworkHandlerMessageClient message, MessageContext ctx) {
