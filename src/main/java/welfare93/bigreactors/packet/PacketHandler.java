...
public class PacketHandler extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
    ...
    public void initialise() {
        this.channels = NetworkRegistry.INSTANCE.newChannel("Hadv", this);
    }
    ...
    public static void encodeString(String a,ByteBuf b)
    {
    	b.writeShort(a.length());
    	for(int i=0;i<a.length();i++)
    		b.writeChar(a.charAt(i));
    }
    public static String decodeString(ByteBuf a)
    {
    	String c="";int d=a.readShort();
    	for(int i=0;i<d;i++)
    		c+=a.readChar();
    	return c;
    }
